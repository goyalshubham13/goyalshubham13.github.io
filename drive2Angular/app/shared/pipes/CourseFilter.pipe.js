        ...
        execute: function() {
            CourseFilterPipe = (function () {
                ...
                CourseFilterPipe.prototype.transform = function (value, args) {
                    ...
                    return filter ? value.filter(function (course) { return course.name.toLowerCase().indexOf(filter) !== -1 || course.author.toLowerCase().indexOf(filter) !== -1; }) : value;
                };
...
//# sourceMappingURL=CourseFilter.pipe.js.map